...
The launcher now passes **--auto** to the checker so it starts the scans right away and agrees to auto-fixes without
extra keystrokes. You only need to double-click and wait for the results.
